...
a<-dat_all %>% 
  ...
  annotate('text', x = 1, y = 5500, label = "a", size = 6)+
  annotate('text', x = 2, y = 2500, label = "ab", size = 6)+
...
b<-dat_all %>% 
  ...
  geom_boxplot(width = 0.7)+
  geom_jitter(width = 0.25, size = 2, alpha = 0.5)+
  annotate('text', x = 1, y = 1.8, label = "ab", size = 6)+
  annotate('text', x = 2, y = 0.5, label = "a", size = 6)+
  annotate('text', x = 3, y = 2.7, label = "b", size = 6)+
